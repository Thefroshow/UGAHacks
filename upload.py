...
#image_path = 'TextbookPic1.jpg'

currentPIN = "ebae97ad8b"

def upload_pic(client, image_path):
	'''
	...
	config = {
		...
		'name':  'Textbook1!',
		'title': '',
		'description': 'Textbook {0}'.format(datetime.now())
	}
...
if __name__ == "__main__":
	client = authenticate()
	image = upload_pic(client, 'TextbookPic1.jpg')
